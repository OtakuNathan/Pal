# Bunshin Layered Architect Planning
...
- The manager creates/binds the draft before the bunshin starts; the model should
...
- Added phase-scoped capability groups:
  - `bunshin_plan_builder_sketch`
  - `bunshin_plan_builder_module_detail`
