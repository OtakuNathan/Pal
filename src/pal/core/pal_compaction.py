...
def _render_pal_compact_context(
    *,
    ...
    lines = [
        ...
        "",
        "This is a summary of earlier conversation, provided only to preserve continuity; it is not a new user request.",
        "Use this background silently. Do not repeatedly mention this summary, the compact block, or the compression process in normal replies.",
