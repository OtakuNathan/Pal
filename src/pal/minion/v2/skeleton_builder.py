...
SKELETON_BUILDER_TOOL_SPECS: dict[str, dict[str, Any]] = {
    "op_minion_architecture_submit": {
        ...
        "description": (
            ...
            "verification_nodes describe real scenarios and the exact module candidates they combine. kind is consumer_probe for a focused real consumer, "
            "end_to_end for a product path, dogfood for a runnable product exercise, or platform for an environment-specific probe. Each entrypoint kind is "
            "source_symbol, build_target, product_entrypoint, or platform_probe; provide the matching path/symbol or target. depends_on must "
