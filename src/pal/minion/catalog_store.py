...
def minion_catalog_root(runtime_root: Path) -> Path:
    return Path(runtime_root) / "data" / "minion" / "catalog"


def profile_override_root(runtime_root: Path) -> Path:
    return minion_catalog_root(runtime_root) / "profile_overrides"


def family_override_root(runtime_root: Path) -> Path:
    return minion_catalog_root(runtime_root) / "family_overrides"
