...
- Bunshin v3 semantic work-checkpoint policy
...
- Bunshin Git reads are a Manager-scoped review surface, not repository
...
- Bunshin uses the selected endpoint/model output limit by default. If a response
