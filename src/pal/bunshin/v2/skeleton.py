...
from pal.bunshin.v2.delivery import is_github_pull_request_remote
from pal.bunshin.v2.paths import (
    bunshin_data_root,
    project_git_layout_lock,
    resolve_project_git_layout,
)
from pal.bunshin.v2.module_protocol import ModuleDefinition
...
class GitBackedSkeletonService:
        ...
        with project_git_layout_lock(layout):
            if not snapshot_marker.is_file():
                snapshot = self._create_synthetic_snapshot(
                    ...
                    snapshot_ref=f"refs/bunshin/snapshots/{layout.workflow_key}",
                )
    ...
    def snapshot_architect_result(
        ...
        *,
        ...
        message = f"bunshin architecture skeleton {revision_name}\n\nPal-Architecture-Key: {commit_key}"
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(prefix="pal-workspace-snapshot-") as temporary:
            ...
            _git(
                ...
                "--allow-empty",
                "-qm",
                "Bunshin synthetic workspace snapshot",
            )
