...
from pal.bunshin.v2.submission_preflight import (
...
_RUN_TO_KIND_TAG = {
    "op_bunshin_verification_run_historical_regression": ("historical_regression", "historical_regressions"),
    "op_bunshin_verification_run_diff_risk": ("diff_risk", "candidate_delta_review"),
    "op_bunshin_verification_run_adversarial_case": ("contract_adversarial", "focused_tests"),
    "op_bunshin_verification_run_focused_test": ("unit", "focused_tests"),
    "op_bunshin_verification_run_compile_check": ("compile", "compile"),
    "op_bunshin_verification_run_warning_check": ("compile", "warning_clean"),
    "op_bunshin_verification_run_consumer_probe": ("consumer_probe", "consumer_probe"),
    "op_bunshin_verification_run_dogfood": ("consumer_probe", "public_surface_dogfood"),
...
_COMMON_VERIFICATION_CAPABILITIES = frozenset(
    {
        ...
        "op_bunshin_verification_run_focused_test",
        "op_bunshin_verification_run_compile_check",
...
VERIFICATION_EVIDENCE_CAPABILITIES = (
    *(
        ...
        if capability != "op_bunshin_verification_scratch_write"
    ),
    "op_bunshin_verification_draft_status",
    "op_bunshin_verification_remove_case",
)
...
VERIFICATION_BUILDER_TOOL_SPECS: dict[str, dict[str, Any]] = {
    ...
    **{
        name: {
            ...
            "InputModel": BunshinV2VerificationBuilderVERIFICATIONBUILDERTOOLSPECSInput,
        }
...
def compile_verification_invocation_tool_contract(
    *,
    ...
    if "public_surface_dogfood" in set(policy["allowed_obligations"]):
        allowed_capabilities.add("op_bunshin_verification_run_dogfood")
    if "platform_probe" in set(policy["allowed_obligations"]):
        allowed_capabilities.add("op_bunshin_verification_run_platform_probe")
    ...
    if policy["mode"] == "sink":
        overrides["op_bunshin_verification_scratch_write"] = {
            "use_when": (
    ...
    overrides["op_bunshin_verification_draft_status"] = {
        "use_when": (
    ...
    overrides["op_bunshin_verification_run_diff_risk"] = {
        "use_when": (
    ...
    overrides["op_bunshin_verification_check_unavailable"] = {"use_when": (
...
async def verification_builder_tool_result(
    ...
    *,
    ...
    if name == "op_bunshin_verification_run_lsp_check":
    ...
    if name == "op_bunshin_verification_check_unavailable":
...
def _assert_tool_contract_allows(
    ...
    *,
    ...
    elif name == "op_bunshin_verification_run_lsp_check":
        obligation = "lsp"
    elif name == "op_bunshin_verification_check_unavailable":
