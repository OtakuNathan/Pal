...
BUNSHIN_START_WORKFLOW_PURPOSE = (
    "Start one durable Bunshin workflow from the complete, lossless authoritative task specification and bind its "
...
class BunshinV2StartWorkflowWorkspace(StrictToolModel):
...
class BunshinV2CapabilitiesBunshinV2PublicProviderStartWorkflowInput(StrictToolModel):
    """Reloadable public contract for starting one Bunshin workflow."""
    ...
    constraints: list[Any] | None = Field(
        ...
        description=(
            ...
            "Product-visible obligations belong in task_spec; Bunshin orchestration policy "
...
class BunshinV2CapabilitiesBunshinV2PublicProviderSubmitHumanDecisionInput(StrictToolModel):
...
class BunshinV2CapabilitiesBunshinV2PublicProviderRebindTaskDeliveryInput(StrictToolModel):
...
@capability_node(
    ...
    scope="bunshin_workflow",
    path_module_id="bunshin_workflow",
    kind="module",
    source="builtin:bunshin-v2",
    target_kind="workflow",
)
@capability_node(
    namespace=INTROSPECTION_NAMESPACE,
    scope="bunshin_task",
    path_module_id="bunshin_task",
    kind="module",
    source="builtin:bunshin-v2",
    target_kind="task",
)
@capability_node(
    ...
    path_module_id="bunshin_catalog",
    kind="module",
    source="builtin:bunshin-v2",
    target_kind="catalog",
)
...
class BunshinV2PublicProvider:
    ...
    def read_catalog(self, call: IntrospectionCall) -> IntrospectionResult:
        try:
            ...
            return IntrospectionResult(
                ...
                structured=payload,
                llm_text=render_titled_structured_for_llm("Bunshin catalog read failed", payload),
            )
    ...
    def set_profile_override(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin profile override updated", payload)
        except Exception as exc:
            return _error("bunshin profile override failed", exc)
    ...
    def reset_profile_override(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin profile override reset", payload)
        except Exception as exc:
            return _error("bunshin profile override reset failed", exc)
    ...
    def set_family_override(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin family override updated", payload)
        except Exception as exc:
            return _error("bunshin family override failed", exc)
    ...
    def reset_family_override(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin family override reset", payload)
        except Exception as exc:
            return _error("bunshin family override reset failed", exc)
    ...
    def refresh_catalog(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin catalog refreshed", payload)
        except Exception as exc:
            return _error("bunshin catalog refresh failed", exc)
    ...
    def start_workflow(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            self._wake()
            return _public_result("bunshin workflow created", payload)
        except ValueError as exc:
            return _invalid("bunshin V2 workflow request invalid", exc)
        except Exception as exc:
            return _error("bunshin V2 workflow start failed", exc)
    ...
    def submit_artifact(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin artifact published", payload)
        except ValueError as exc:
            return _invalid("bunshin V2 artifact invalid", exc)
        except Exception as exc:
            return _error("bunshin V2 artifact publish failed", exc)
    ...
    def search_tasks(self, call: IntrospectionCall) -> IntrospectionResult:
        try:
            ...
            return IntrospectionResult(
                status=RuntimeStatus.OK,
                text="bunshin task search",
                structured=public,
                llm_text=render_titled_structured_for_llm("Bunshin task search", public),
            )
        except ValueError as exc:
            return IntrospectionResult(
    ...
    def workflow_status(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin task status", payload)
        except ValueError as exc:
            return _invalid("bunshin task selection invalid", exc)
        except Exception as exc:
            return _error("bunshin V2 workflow status failed", exc)
    ...
    def resume_workflow(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            self._wake()
            return _public_result("bunshin workflow resume requested", payload)
        except ValueError as exc:
            return _invalid("bunshin V2 workflow cannot resume", exc)
        except Exception as exc:
            return _error("bunshin V2 workflow resume failed", exc)
    ...
    def restart_execution(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            self._wake()
            return _public_result("bunshin execution restart requested", payload)
        except ValueError as exc:
            return _invalid("bunshin V2 execution restart invalid", exc)
        except Exception as exc:
            return _error("bunshin V2 execution restart failed", exc)
    ...
    def resolve_triage(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            self._wake()
            return _public_result("bunshin triage resolved", payload)
        except ValueError as exc:
            return _invalid("bunshin V2 triage resolution invalid", exc)
        except Exception as exc:
            return _error("bunshin V2 triage resolution failed", exc)
    ...
    def submit_human_decision(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            self._wake()
            return _public_result("bunshin human decision accepted", payload)
        except ValueError as exc:
            return _invalid("bunshin V2 human decision stale or invalid", exc)
        except Exception as exc:
            return _error("bunshin V2 human decision failed", exc)
    ...
    def rebind_task_delivery(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _public_result("bunshin Task delivery rebound", public)
        except ValueError as exc:
            return _invalid("bunshin Task delivery rebind invalid", exc)
        except Exception as exc:
            return _error("bunshin Task delivery rebind failed", exc)
    ...
    def answer_question(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            if self.manager_request is None:
                raise RuntimeError("bunshin sidecar request path is unavailable")
            ...
            return _public_result("bunshin question answered", payload)
        except ValueError as exc:
            return _invalid("bunshin question answer invalid", exc)
        except Exception as exc:
            return _error("bunshin question answer failed", exc)
    ...
    def control_workflow(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            self._wake()
            return _public_result("bunshin workflow control requested", payload)
        except ValueError as exc:
            return _invalid("bunshin V2 workflow control invalid", exc)
        except Exception as exc:
            return _error("bunshin V2 workflow control failed", exc)
    ...
    def archive_workflow(self, call: CapabilityCall) -> CapabilityResult:
        try:
            ...
            return _error("bunshin V2 workflow archive failed", exc)
    ...
    def _request_manager(self, method: str, params: dict[str, Any] | None = None) -> dict[str, Any]:
        if self.manager_request is None:
            raise RuntimeError("bunshin sidecar request transport is not configured")
