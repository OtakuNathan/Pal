...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "endpoint_spec_fingerprint": ("pal.llm.endpoint_spec", "endpoint_spec_fingerprint"),
    ...
    "PromptRegionIR": ("pal.llm.ir", "PromptRegionIR"),
    "PromptCacheCoordinator": ("pal.llm.prompt_cache", "PromptCacheCoordinator"),
    "PromptCacheDialect": ("pal.llm.prompt_cache", "PromptCacheDialect"),
    ...
    "ProviderResponseHook": ("pal.llm.response_hooks", "ProviderResponseHook"),
    "ProviderResponseHookContext": ("pal.llm.response_hooks", "ProviderResponseHookContext"),
    "ProviderResponseHookError": ("pal.llm.response_hooks", "ProviderResponseHookError"),
    "ProviderResponseHookRegistry": ("pal.llm.response_hooks", "ProviderResponseHookRegistry"),
    ...
    "RuntimeSettingSnapshot": ("pal.llm.repository", "RuntimeSettingSnapshot"),
    ...
    "DirectSDKTransport": ("pal.llm.transport", "DirectSDKTransport"),
    "EncodedTransportRequest": ("pal.llm.transport", "EncodedTransportRequest"),
    "LLMJSONTransportPort": ("pal.llm.transport", "LLMJSONTransportPort"),
