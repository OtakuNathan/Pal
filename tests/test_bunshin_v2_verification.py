...
class BunshinV2VerificationTests(unittest.TestCase):
        ...
        *,
        ...
        if role in {"reviewer", "verifier"}:
            initialized = update_checklist_tool_result(
                new_tool_call(
                    name="op_bunshin_update_checklist",
                    args={
                        "plan": [
                            {
    ...
    def _candidate_call(
        ...
        if name == "op_bunshin_update_checklist":
    ...
    def test_verifier_submit_schema_is_the_only_completion_shape(self) -> None:
        schema = VERIFICATION_BUILDER_TOOL_SPECS["op_bunshin_verification_submit"][
            "InputModel"
    ...
    def test_verifier_submit_validates_and_materializes_only_the_canonical_artifact(self) -> None:
        ...
        result = self._verification_call(
            workspace, "op_bunshin_verification_submit", produced=produced
        )
    ...
    def test_verifier_keeps_running_when_historical_order_fails_submit(self) -> None:
        ...
        submitted = self._verification_call(
            workspace, "op_bunshin_verification_submit", produced=[]
        )
        ...
        status = self._verification_call(
            workspace, "op_bunshin_verification_draft_status"
        )
    ...
    def test_candidate_submit_accepts_review_guarded_contract_as_live_git_delta(self) -> None:
        ...
        unfinished = self._candidate_call(workspace, "op_bunshin_candidate_submit")
        ...
        accepted = self._candidate_call(workspace, "op_bunshin_candidate_submit")
    ...
    def test_artifact_candidate_submit_rejects_an_empty_product_workspace(self) -> None:
        ...
        self.assertTrue(planned.ok, planned.text)
        submitted = self._candidate_call(workspace, "op_bunshin_candidate_submit")
        self.assertFalse(submitted.ok)
    ...
    def test_case_reuse_hashes_only_its_declared_scratch_probe(self) -> None:
        ...
        first = self._verification_call(
            workspace, "op_bunshin_verification_run_adversarial_case", args
        )
        self.assertTrue(first.ok, first.text)
        self.assertTrue(
    ...
    def test_invocation_tool_contract_is_stable_and_structural(self) -> None:
        ...
        self.assertIn(
            "op_bunshin_verification_run_consumer_probe",
            first["allowed_capabilities"],
        )
        self.assertNotIn(
            "op_bunshin_verification_run_dogfood",
            first["allowed_capabilities"],
        )
        self.assertNotIn(
            "op_bunshin_verification_run_platform_probe",
            first["allowed_capabilities"],
        )
        self.assertNotIn(
            "op_bunshin_verification_run_historical_regression",
    ...
    def test_sink_tool_contract_exposes_delivery_usage_mode(self) -> None:
        ...
        self.assertIn("op_bunshin_verification_run_dogfood", capabilities)
        self.assertNotIn("op_bunshin_verification_run_consumer_probe", capabilities)
        self.assertNotIn("op_bunshin_verification_run_platform_probe", capabilities)
        ...
        self.assertNotIn(
            "op_bunshin_verification_run_consumer_probe", platform_capabilities
        )
        self.assertIn(
            "op_bunshin_verification_run_platform_probe", platform_capabilities
        )
        self.assertIn(
            "op_bunshin_verification_run_dogfood", platform_capabilities
        )
    ...
    def test_mixed_defect_submission_preserves_findings_and_compiles_one_route(self) -> None:
        ...
        for finding_kind, case in (
            ...
            self.assertTrue(finding.ok, finding.text)
        submitted = self._verification_call(
            workspace, "op_bunshin_verification_submit"
        )
        self.assertTrue(submitted.ok, submitted.text)
        compiled = json.loads(
    ...
    def test_verifier_cannot_author_requirement_records(self) -> None:
        ...
        proposal = self._verification_call(
            workspace,
            "op_bunshin_verification_propose_requirement_patch",
            {
    ...
    def test_patch_delivery_does_not_preflight_github(self) -> None:
        ...
        remote_branch = subprocess.run(
            [
                ...
                "--exit-code",
                str(remote),
                "refs/heads/pal/bunshin/pr-preflight-fallback",
            ],
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
            text=True,
