...
class PalV2ArchitectureSkeletonTests(unittest.TestCase):
    ...
    def test_minimal_operating_rules_prompt_omits_route_specific_tools(self) -> None:
        ...
        self.assertIn("user preferences", knowledge_storage_boundary.content)
        self.assertNotIn("routing suggestions in behavior", knowledge_storage_boundary.content)
        self.assertIn('durable facts', knowledge_storage_boundary.content)
        self.assertIn('repair experience', knowledge_storage_boundary.content)
